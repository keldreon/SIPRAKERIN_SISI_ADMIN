...
<head>
	...
	<title>Add Pembimbing Lab &nbsp | &nbsp Sistem Informasi Praktek Kerja Industri</title>
      ...
      <div class="app" id="app">
		...
		<aside class="sidebar">
            <div class="sidebar-container">
				...
				<?php $tes = $this->session->flashdata('nform');?>
                ...
                <article class="content item-editor-page">
					...
					<?php if($tes == 0){?>
                    <h3 class="title"> Edit Pembimbing Lab <?php//harusnya nama lab?>
					<?php }else if($tes==1){?>
						<h3 class="title"> Add Pembimbing Lab <?php//harusnya nama lab?>
					<?php } ?>                        				
                          <span class="sparkline bar" data-type="bar"></span>
                        </h3>
						<p class="title-description"><?php//deskripsi lab?></p>
                    </div>											
					<?php $attributes = array("name" => "pemblabform", "id"=>"pemblabform");
				echo form_open('HakKelola/prosesInsertPembLab', $attributes);?>					
						...
						<?php }?>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
								<?php if($tes == 0){?>
										<input type="text" class="form-control boxed" placeholder="Nama Pembimbing Laboratorium" name="nama" value="<?php echo $laboratorium->nama_pemb_lab;?>"></div>
								<?php }else if($tes==1){?>
										<input type="text" class="form-control boxed" placeholder="Nama Pembimbing Laboratorium" name="nama" required>
										</div>
								<?php } ?>                                    
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="selectpicker" name="lab_id"  >				  
									<?php foreach($laboratorium->result() as $dataPemb){?>
										<option value="<?php echo $dataPemb->id_lab;?>"><?php echo $dataPemb->nama_lab;?></option>
									<?php }?>					
									</select>
                            </div>							
							</div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Apakah anda yakin akan menambahkan data? <br/> Untuk Perubahan Ulang Harap lakukan di menu edit...</p>
                            </div>
