...
<html lang="en">
  <head>
    ...
    <title>Daftar Pengajuan Praktek Kerja Industri | Sistem Informasi Prakerin SMK</title>
		...
		<aside class="sidebar">
            <div class="sidebar-container">
				...
				<div class="title-block">
                        <h1 class="title"> Daftar Pengajuan Prakterk Kerja Industri</h1>
                        ...
                        <p class="title-description">Pengajuan tempat praktek kerja industri dari sekoah lewat pembimbing.</p>
						<!--tombol delete-->						
				</div>
				</div>
                                 ...
                                 <div class="card-block">                                        
											...
											<div class="table-responsive">
												<table class="table table-striped">
													...
													<tbody>
													<?php foreach($data_pengajuan->result() as $lab):?>			  													
														<tr>		
															<?php array_push($iDe,$lab->kode_masuk);?>
															<td><?php echo $lab->tanggal_pengajuan; ?></td>
															<td>
															<a href="<?php echo site_url('Pengajuan/klikPengajuan/' .$lab->kode_masuk);?>" ><?php echo $lab->nama_pembimbing; ?></a>
															<?php if($lab->status_pemrosesan == 0){?>																														
																<i class="fa fa-times-circle"></i>
															<?php }else if($lab->status_pemrosesan == 1){?>
																<i class="fa fa-check-circle"></i>
															<?php } ?>
															</td>				
															<td><?php echo $lab->nama_sekolah; ?></td>    															
															<td><?php echo $lab->nama_lab; ?></td>                  															
															<td><?php if($lab->status_pemrosesan == 1){?>
																		<a href="<?php echo site_url('Pengajuan/EditklikPengajuan/' .$lab->kode_masuk);?>">Edit</a> | 
																	<?php }?>
																	<a href="#" data-toggle="modal" data-target="#confirm-modal_<?php echo $lab->kode_masuk?>">Delete</a>
															</td>
														</tr>					
													</tbody>			  
													<?php endforeach ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Apakah anda yakin akan melakukan ini? <br/> Menghapus pengajuan berarti menghapus <b>SEMUA</b> data yang terikat dengan pengajuan.</p>
                            </div>
                            <div class="modal-footer">
                                <a name="delete" class="btn btn-secondary" href="<?php echo site_url('HakKelola/deletePengajuan/' .$iDe[$x]);?>">Ya</a>
