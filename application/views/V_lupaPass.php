                ...
                <div class="card">
                    ...
                    <div class="auth-content">
                        ...
                        <p class="text-muted text-center">
                            <small>Masukkan username untuk mengembalikan password.</small>
                        </p>
						<?php $attributes = array("id"=>"reset-form");
							echo form_open("HakKelola/lupaPassword", $attributes);?>                        
                            <div class="form-group">
                                <label for="email1">Username</label>
                                <input type="email" class="form-control underlined" name="username" id="username" placeholder="Username Admin..." required> </div>
                            <div class="form-group">
