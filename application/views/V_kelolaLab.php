...
<html lang="en">
  <head>
    ...
    <title>Laboratorium | Sistem Informasi Prakerin SMK</title>
		...
		<aside class="sidebar">
            <div class="sidebar-container">
				...
				<div class="title-block">
                        <h1 class="title"> Daftar Laboratorium Prakterk Kerja Industri
						<a href="<?php echo site_url("Laboratorium/addLab");?>" class="btn btn-primary btn-sm rounded-s"> Add New </a>							
						</h1>
							  ...
							  <div class="card">
                                 <div class="card-block">                                        
										...
										<div class="table-responsive">
											...
											<tbody>
											<?php foreach($dataLab->result() as $lab):?>			  
											<?php array_push($iDe, $lab->id_lab); ?>	
											<tr>																																			
												<?php  $i=$i+1; ?>
												<td><?php echo $i;?></td>				                    
												<td><?php echo $lab->nama_lab; ?></td>
												<td>
														<a href="<?php echo site_url('Laboratorium/getLab/' .$lab->id_lab);?>" >Detail</a> | 																												
														<?php if($lab->status == 1){?>
														<a href="<?php echo site_url('HakKelola/matikanLab/' .$lab->id_lab);?>" >Tutup</a> |
														<?php }else if($lab->status == 0){?>
														<a href="<?php echo site_url('HakKelola/aktifkanLab/' .$lab->id_lab);?>" >Buka</a> |
														<?php }?>
														<a href="#" data-toggle="modal" data-target="#confirm-modal_<?php echo $lab->id_lab;?>" >Delete</a>
												</td>
											</tr>					
											</tbody>											
											<?php endforeach ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a name="delete" class="btn btn-secondary" href="<?php echo site_url('HakKelola/deleteLab/' .$iDe[$x]);?>">Ya</a>
