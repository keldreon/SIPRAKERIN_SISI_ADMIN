...
<html lang="en">
  <head>
    ...
    <title>Data Pembimbing Siswa | Sistem Informasi Prakerin SMK</title>
            ...
            <div class="sidebar-container">
                ...
                <article class="content responsive-tables-page items-list-page">
				   <div class="title-search-block">                                                    
                        ...
                        <h1 class="title">Data Pembimbing
						</h1>
                        ...
                        <p class="title-description">Tempat kelola data pembimbing termasuk data sekolah baik untuk di-edit atau di delete...</p>
						<!--tombol delete-->
				</div>
				</div>
                                 ...
                                 <div class="card-block">                             
											...
											<div class="table-responsive">
												<table class="table table-striped">
													...
													<tbody>
													<?php foreach($dataPembimbing->result() as $lab):?>			  
													<?php array_push($iDe, $lab->kode_masuk); ?>	
														<tr>				
															<td><?php echo $lab->kode_masuk; ?></td>
															<td>															
															<!--<a href="<?php //echo site_url('Home/klikPengajuan/' .$lab->kode_masuk);?>" ></a>-->
															<?php echo $lab->nama_pembimbing; ?> 
															</td>
															<td><?php echo $lab->nama_sekolah; ?></td> 															
															<td>													
																<i class="fa"></i> <a href="<?php echo site_url('DataPembimbing_SekolahSiswa/getPembimbing_Sekolah/' .$lab->kode_masuk);?>" >Detail</a> | 																 
																<i class="fa fa-pencil"></i> <a href="<?php echo site_url('DataPembimbing_SekolahSiswa/EditPembimbing_Sekolah/' .$lab->kode_masuk);?>" >Edit</a> | 																 
																<i class="fa fa-times"></i> <a href="#" data-toggle="modal" data-target="#confirm-modal_<?php echo $lab->kode_masuk?>">Delete</a>
															</td>
														</tr>					
													</tbody>			  
													<?php endforeach ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a name="delete" class="btn btn-secondary" href="<?php echo site_url('HakKelola/deletePembimbing/' .$iDe[$x]);?>">Ya</a>
