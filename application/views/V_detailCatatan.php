...
<head>
	...
	<title>Edit Catatan Kegiatan Siswa | Sistem Informasi Praktek Kerja Industri</title>
			...
			<div class="sidebar-overlay" id="sidebar-overlay"></div>
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Edit Catatan<?php//harusnya judul?>
                            <span class="sparkline bar" data-type="bar"></span>
                        </h3>
						<p class="title-description"><?php //echo $laboratorium->desk_lab;?></p>
                    </div>	
                    <?php $attributes = array("name" => "catatanform", "id"=>"catatanform");
				echo form_open_multipart('HakKelola/prosesEditIsiKegiatan', $attributes);?>
                        <div class="card card-block">						
						<input name="id_kegiatan" type="hidden" value="<?php echo $dataKegiatan->id_kegiatan; ?>" />
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Judul: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Edit Judul" name="judul" value="<?php echo $dataKegiatan->judul_tulisan;?>" ></div>									
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Isi: </label>								
                                <div class="col-sm-10">
								<textarea class="form-control boxed" name="teks" id="teks" placeholder="Kegiatanku Hari ini..." rows="6" cols="60" value="<?php form_textarea(array('teks'=>'teks'),set_value('teks'));?>"><?php echo $dataKegiatan->isi_tulisan;?></textarea> </div>
                            </div>							
							<div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <a href="#" value="Submit" class="btn btn-primary" data-toggle="modal" data-target="#confirm-modal">Submit</a>
									<a class="btn btn-secondary" href="<?php echo base_url(); ?>index.php/DataSiswa/CatatanKegiatan">Batal</a>
                                </div>
                            </div>
						</div>												
						<?php //if(){?>
