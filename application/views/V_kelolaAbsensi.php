...
<html lang="en">
  <head>
    ...
    <title>Absensi Siswa | Sistem Informasi Prakerin SMK</title>
  ...
  <div class="main-wrapper">
		...
		<aside class="sidebar">
            <div class="sidebar-container">
				...
				<div class="title-block">
                        <h1 class="title"> Daftar Absensi Siswa						
						</h1>
                        <p class="title-description">Masalah Absensi bisa diurus disini.</p>
				</div>
                           ...
                           <div class="col-md-12">
							  <div class="card">
                                 <div class="card-block">                                        
										<?php  $i=0; ?>
										<?php $iDe = array();?>
										<?php if(!empty($catatanAbsen)){?>										
										<?php $attributes = array("name"=>"absenform" , "id"=>"absenform");
												echo form_open("HakKelola/prosesAbsensi", $attributes);?>
										<div class="table-responsive">
											...
											<tr>	
												<?php array_push($iDe,$ca->id_absen);?>
												<td><input name="id_absen[]" type="hidden" value="<?php echo $ca->id_absen; ?>" /><?php $i=$i+1;?><?php echo $i;?></td>				                    
												...
												<td><?php if($ca->acc_pembimbing==0 ||$ca->acc_pembimbing==NULL){ ?>
															<input type="checkbox" class="form-check-input" id="accAbsen"  class="custom-control-input" name="accAbsen[]" value="1"> Hadir
														<?php }else{?>
															<input type="checkbox"  class="form-check-input" id="accAbsen" name="accAbsen[]" class="custom-control-input" value="1" disabled checked> Hadir
														<?php } ?>
												</td>	
												<td>
													<?php if($ca->acc_pembimbing==1){ ?>
																<i class="fa fa-times-circle"></i> <a href="<?php echo site_url('HakKelola/cancelAbsensi/' .$ca->id_absen);?>" >Batalkan</a>
													<?php }else{ ?>
																<i class="fa fa-check-circle"></i> <a href="<?php echo site_url('HakKelola/hadirAbsensi/' .$ca->id_absen);?>" >Hadir</a>
													<?php } ?>
												</td>
											</tr>					
											</tbody>			  
									...
									<div class="form-group row">
										<div class="col-sm-12 col-sm-offset-2">
											<button id="acc" class="btn btn-lg btn-primary btn-block" type="submit">Simpan</button>																						
										</div>
								</div>		
									<?php echo form_close();?>									
									<?php }else{?>
	...
	<script>
	var checker = document.getElementById('accAbsen');
	var sendbtn = document.getElementById('acc');
