...
<html lang="en">
  <head>
    ...
    <title>Daftar Catatan Kegiatan Siswa Praktek Kerja Industri | Sistem Informasi Prakerin SMK</title>
		...
		<aside class="sidebar">
            <div class="sidebar-container">
				...
				<div class="title-block">
                        <h1 class="title"> Daftar Catatan Kegiatan Siswa Prakterk Kerja Industri</h1>
                        ...
                        <p class="title-description">Catatan Kegiatan untuk di acc.</p>
						<!--tombol delete-->						
				</div>
				</div>
											...
											<div class="table-responsive">
												<table class="table table-striped">
													...
													<tr>				
														...
														<th><?php //link ke detail?>Judul</th>
														<th>Penulis</th>				  														
														<th>Pembimbing Laboratorium</th>
														<th> &nbsp </th>
														<!--<th>Jumlah Siswa</th>-->
													</tr>
													</thead>			  
													<tbody>
													<?php foreach($dataKegiatan->result() as $lab):?>			  													
														<tr>		
															<?php array_push($iDe,$lab->id_kegiatan);?>
															<td><?php echo $lab->tanggal_pengajuan; ?></td>
															<td>
															<a href="<?php echo site_url('DataSiswa/IsiCatatanKegiatan/' .$lab->id_kegiatan);?>" ><?php echo $lab->judul_tulisan; ?></a>
															<?php if($lab->acc_pembimbing == 0){?>																														
																<i class="fa fa-times-circle"></i>
															<?php }else if($lab->acc_pembimbing == 1){?>
																<i class="fa fa-check-circle"></i>
															<?php } ?>
															</td>				
															<td><?php echo $lab->username_akun; ?></td>    															
															<td><?php echo $lab->nama_pemb_lab; ?></td>                  															
															<td>
																	<a href="<?php echo site_url('DataSiswa/EditCatatanKegiatan/' .$lab->id_kegiatan);?>">Edit</a> |											
															
																	<a href="#" data-toggle="modal" data-target="#confirm-modal_<?php echo $lab->id_kegiatan;?>">Delete</a>
															</td>
														</tr>					
													</tbody>			  
													<?php endforeach ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Apakah anda yakin akan menghapus catatan ini? </p>
                            </div>
                            <div class="modal-footer">
                                <a name="delete" class="btn btn-secondary" href="<?php echo site_url('HakKelola/deleteCatatankegiatan/' .$iDe[$x]);?>">Ya</a>
