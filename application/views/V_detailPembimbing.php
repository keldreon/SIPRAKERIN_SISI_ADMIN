            ...
            <div class="sidebar-container">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Detail Pembimbing
				...
				<div class="card card-block">
						...
						<input name="kode_masuk" type="hidden" value="<?php echo $dataSekolah->kode_masuk; ?>" />
                            <div class="form-group row">							
                                ...
                                <div class="col-sm-10">								
                                    <input type="text" class="form-control boxed" placeholder="Nama Sekolah" id="nSekolah" name="nama_sekolah" value="<?php echo $dataSekolah->nama_sekolah;?>" readonly></div>
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Alamat Sekolah: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Alamat Sekolah" name="alamat_sekolah" value="<?php echo $dataSekolah->alamat_sekolah;?>" readonly> </div>
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Kontak Sekolah: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Kontak Sekolah" name="kontak_sekolah"value="<?php echo $dataSekolah->kontak_sekolah;?>" readonly> </div>
                            </div>
							</div>
							<div class="card card-block">							
							<div class="title-block">
							...
							<div class="form-group row">														
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Nama Pembimbing" name="name" value="<?php echo $dataPembimbing->nama_pembimbing;?>" readonly> </div>
                            </div>							
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Jabatan : </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Jabatan Pembimbing" name="job" value="<?php echo $dataPembimbing->jabatan_pembimbing;?>" readonly> </div>
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Kontak : </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Kontak Pembimbing" name="kontak" value="<?php echo $dataPembimbing->kontak_pembimbing;?>" readonly> </div>								
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Email : </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Email Pembimbing" name="email" value="<?php echo $dataPembimbing->email_pembimbing;?>" readonly> </div>
                            </div>
							<br/>
							<div class="form-group row">
