...
<html lang="en">
  <head>
    ...
    <title>Data Akun Praktek Kerja Industri | Sistem Informasi Prakerin SMK</title>
            ...
            <div class="sidebar-container">
                ...
                <article class="content responsive-tables-page items-list-page">
				   <div class="title-search-block">                                                    
                        ...
                        <h1 class="title"> Akun Siswa 						
						<a href="<?php echo site_url('HakKelola/resetPasswordSiswa')?>" class="btn btn-primary btn-sm rounded-s">Reset Password</a>
						</h1>
                        ...
                        <p class="title-description">Tempat kelola data akun siswa baik untuk di-edit atau di delete...</p>
						<!--tombol delete-->
				</div>
				</div>
                           ...
                           <div class="col-md-12">
							  <div class="card">
                                 <div class="card-block">                                        
											<?php $iDe = array();?> 
											<?php if(!empty($dataAkunSiswa)){?>
											<div class="table-responsive">
												<table class="table table-striped">
													<thead>
													<tr>									
														<th>Kode Akun Siswa</th>
														<th>Username</th>
														<th>Nama Siswa</th>				  																																										
														<th> &nbsp </th>
													</tr>
													...
													<tbody>
													<?php foreach($dataAkunSiswa->result() as $lab):?>			  
													<?php array_push($iDe,$lab->id_akun);?>
														<tr>				
															<td><?php echo $lab->kode_referal; ?></td>
															<td>
															<?php if($lab->username_akun == NULL){?>
																[Belum Terpakai]
															<?php }else{?>
															<?php echo $lab->username_akun; ?> 
															<?php } ?>
															<?php if($lab->aktivasi_akun == 1){ ?>
																<i class="fa fa-check-circle"></i>
															<?php }else if($lab->aktivasi_akun == 0){ ?>
																<i class="fa fa-times-circle"></i>
															<?php }  ?>
															</td>
															<td><?php echo $lab->nama_siswa; ?></td> 															
															<td>											
																<i class="fa fa-pencil"></i> <a href="<?php echo site_url('DataSiswa/getAkunSiswa/' .$lab->kode_referal);?>" >Edit</a> | 
																<?php if($lab->aktivasi_akun==1){?>
																<i class="fa fa-power-off"></i> <a href="<?php echo site_url('HakKelola/matikanAkun/' .$lab->kode_referal);?>" >Matikan Akun </a> | 
																<?php }else if($lab->aktivasi_akun==0){?>
																<i class="fa fa-power-off"></i> <a href="<?php echo site_url('HakKelola/aktifkanAkun/' .$lab->kode_referal);?>" >Aktifkan Akun </a> | 
																<?php }?>
																<i class="fa fa-times"></i> <a href="#" data-toggle="modal" data-target="#confirm-modal_<?php echo $lab->id_akun;?>">Delete</a>																
															</td>
														</tr>					
													</tbody>			  
													<?php endforeach ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a name="delete" class="btn btn-secondary" href="<?php echo site_url('HakKelola/deleteAkun/' .$iDe[$x]);?>">Ya</a>
