...
<head>
	...
	<title>Detail Catatan Kegiatan Siswa | Sistem Informasi Praktek Kerja Industri</title>
            ...
            <div class="sidebar-container">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"><?php echo $dataKegiatan->judul_tulisan;?>
                            <span class="sparkline bar" data-type="bar"></span>
                        </h3>
						<p class="title-description">Penulis : <?php echo $dataKegiatan->username_akun;?></p>
						<p class="title-description">Alias : <?php echo $dataKegiatan->nama_siswa;?></p>						
                    </div>	                    
                        <div class="card card-block">						
						<input name="id_kegiatan" type="hidden" value="<?php echo $dataKegiatan->id_kegiatan; ?>" />                            
							<div class="form-group row">
								<div class="col-sm-5">
								<p class="title-description text-left">Pembimbing : <?php echo $dataKegiatan->nama_pembimbing;?></p>
								<p class="title-description">Pembimbing Lab: <?php echo $dataKegiatan->nama_pemb_lab;?></p>
								</div>
							</div>
							<div class="form-group row">                                
                                <div class="col-sm-12">
								<textarea class="form-control boxed" name="teks" id="teks" placeholder="Kegiatanku Hari ini..." rows="6" cols="60"  readonly><?php echo $dataKegiatan->isi_tulisan;?></textarea> </div>
                            </div>														
							<div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">                                    
									<a class="btn btn-secondary" href="<?php echo base_url(); ?>index.php/DataSiswa/CatatanKegiatan">Kembali</a>
                                </div>
                            </div>
						</div>												
						<?php //if(){?>
