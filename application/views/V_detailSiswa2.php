				...
				<div class="card card-block">				
						<input name="id_siswa" type="hidden" value="<?php echo $dataSiswa->id_siswa; ?>" />
                            <div class="form-group row">														
                                ...
                                <div class="col-sm-10">								
                                    <input type="text" class="form-control boxed" placeholder="NIS Siswa"  name="nis" value="<?php echo $dataSiswa->NIS_siswa;?>"></div>
                            </div>
							<div class="form-group row">														
                                <label class="col-sm-2 form-control-label text-xs-right"> Nama Siswa: </label>
                                <div class="col-sm-10">								
                                    <input type="text" class="form-control boxed" placeholder="Nama Siswa"  name="nama" value="<?php echo $dataSiswa->nama_siswa;?>"></div>
                            </div>
							<div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Jurusan Siswa: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Jurusan Siswa" name="jurusan" value="<?php echo $dataSiswa->jurusan_siswa;?>"> </div>																	
                            </div>							
							<div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <button type="submit" class="btn btn-primary" >Simpan</button>									
									<a class="btn btn-secondary" href="<?php echo base_url(); ?>index.php/DataSiswa/index">Batal</a>
                                </div>
                            </div>
						</div>	
				<?php echo form_close(); ?>																
